...
export const CreditCalculator: React.FC = () => {
  ...
  const [monthlyInvoices, setMonthlyInvoices] = useState<number>(3000);
          ...
          <div className="p-8 lg:p-10 lg:col-span-5 bg-gradient-to-br from-indigo-900 via-slate-900 to-indigo-950 text-white flex flex-col justify-between">
            ...
            <div className="pt-8 space-y-3">
              <a
                ...
                className="w-full py-4 rounded-2xl bg-emerald-500 hover:bg-emerald-600 active:scale-95 text-slate-950 font-bold text-xs shadow-lg shadow-emerald-500/20 transition flex items-center justify-center gap-2"
              >

...
export const FeatureShowcase: React.FC = () => {
  ...
  return (
    <section id="features" className="py-24 bg-slate-50 border-t border-b border-slate-200/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featureCards.map((feat, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-7 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
              >
                <div>

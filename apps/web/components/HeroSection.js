...
const HeroSection = () => {
    ...
    return (<section className="relative overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-28 bg-gradient-to-b from-indigo-50/50 via-white to-slate-50/80">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50 border border-indigo-200/60 shadow-sm text-xs font-bold text-indigo-700">
              <lucide_react_1.Sparkles className="w-3.5 h-3.5 text-indigo-600 animate-spin"/>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              <a href={`${dashboardUrl}/register`} className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-4 rounded-2xl bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white font-bold text-sm shadow-xl shadow-indigo-200 transition">
                <span>{t.hero.ctaPrimary}</span>
                <lucide_react_1.ArrowRight className="w-4 h-4"/>
              </a>

              <link_1.default href="/docs" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-4 rounded-2xl bg-white hover:bg-slate-50 active:scale-95 text-slate-800 font-bold text-sm border border-slate-200 shadow-sm transition">
                <lucide_react_1.Cpu className="w-4 h-4 text-indigo-600"/>
            ...
            <p className="text-xs text-slate-500 flex items-center justify-center lg:justify-start gap-2 pt-1">
              <lucide_react_1.ShieldCheck className="w-4 h-4 text-emerald-600"/>
                ...
                <div className="rounded-xl p-3 bg-white border border-slate-200 shadow-lg space-y-2 animate-bounce-short">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-bold text-indigo-600 flex items-center gap-1">
                      <lucide_react_1.Zap className="w-3 h-3 text-indigo-600 fill-indigo-600"/>

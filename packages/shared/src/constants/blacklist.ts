 ...
 */
export const PROHIBITED_DEBIT_PATTERNS: ReadonlyArray<{ pattern: RegExp; name: string }> = [
 ...
 */
export function checkDebitBlacklist(message: string | null | undefined): DebitCheckResult {
